    ...
    <>
      ...
      >
        <div className="container mx-auto p-3 md:p-0 flex flex-col items-center justify-center ">
          <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-6xl 2xl:text-8xl font-mono text-slate-700 ">
            Bizning Ustozlar
          </h1>
          <p className="text-sm md:text-base  text-gray-800 w-full md:w-[500px] lg:w-[600px] text-center mt-6 font-mono">
